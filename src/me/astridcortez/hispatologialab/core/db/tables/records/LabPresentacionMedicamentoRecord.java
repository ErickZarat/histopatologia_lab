...
public class LabPresentacionMedicamentoRecord extends TableRecordImpl<LabPresentacionMedicamentoRecord> implements Record7<Integer, Integer, String, LocalDate, String, LocalDate, String> {
     ...
     */
    public void setTipoPresentacion(Integer value) {
        set(1, value);
    }
    ...
    @Override
    public Row7<Integer, Integer, String, LocalDate, String, LocalDate, String> valuesRow() {
    ...
    @Override
    public LabPresentacionMedicamentoRecord values(Integer value1, Integer value2, String value3, LocalDate value4, String value5, LocalDate value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LabPresentacionMedicamentoRecord(Integer codMedicamento, Integer tipoPresentacion, String estadoMedicamento, LocalDate fechaCreacion, String creadoPor, LocalDate fechaModificacion, String modificadoPor) {
        super(LabPresentacionMedicamento.LAB_PRESENTACION_MEDICAMENTO);
