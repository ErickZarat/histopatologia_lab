...
public class LabPresentacionMedicamentoRecord extends UpdatableRecordImpl<LabPresentacionMedicamentoRecord> implements Record8<Integer, Integer, String, String, LocalDate, String, LocalDate, String> {

    private static final long serialVersionUID = 1L;

    /**
     * Setter for <code>public.lab_presentacion_medicamento.cod_presentacion</code>.
     */
    public void setCodPresentacion(Integer value) {
        set(0, value);
    }

    /**
     * Getter for <code>public.lab_presentacion_medicamento.cod_presentacion</code>.
     */
    ...
    @Override
    public Row8<Integer, Integer, String, String, LocalDate, String, LocalDate, String> valuesRow() {
        return (Row8) super.valuesRow();
    }

    @Override
    public Field<Integer> field1() {
        return LabPresentacionMedicamento.LAB_PRESENTACION_MEDICAMENTO.COD_PRESENTACION;
    }
    ...
    public LabPresentacionMedicamentoRecord value1(Integer value) {
        setCodPresentacion(value);
        return this;
    }

    @Override
    public LabPresentacionMedicamentoRecord value2(Integer value) {
    ...
    @Override
    public LabPresentacionMedicamentoRecord value4(String value) {
        setEstadoMedicamento(value);
        return this;
    }

    @Override
    public LabPresentacionMedicamentoRecord value5(LocalDate value) {
        setFechaCreacion(value);
        return this;
    }

    @Override
    public LabPresentacionMedicamentoRecord value6(String value) {
        setCreadoPor(value);
        return this;
    }

    @Override
    public LabPresentacionMedicamentoRecord value7(LocalDate value) {
        setFechaModificacion(value);
        return this;
    }

    @Override
    public LabPresentacionMedicamentoRecord value8(String value) {
        setModificadoPor(value);
        return this;
    }

    @Override
    public LabPresentacionMedicamentoRecord values(Integer value1, Integer value2, String value3, String value4, LocalDate value5, String value6, LocalDate value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LabPresentacionMedicamentoRecord(Integer codPresentacion, Integer codMedicamento, String tipoPresentacion, String estadoMedicamento, LocalDate fechaCreacion, String creadoPor, LocalDate fechaModificacion, String modificadoPor) {
        super(LabPresentacionMedicamento.LAB_PRESENTACION_MEDICAMENTO);

        setCodPresentacion(codPresentacion);
