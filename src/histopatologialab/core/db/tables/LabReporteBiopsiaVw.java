...
public class LabReporteBiopsiaVw extends TableImpl<LabReporteBiopsiaVwRecord> {
    ...
    /**
     * The column <code>public.lab_reporte_biopsia_vw.procedimiento</code>.
     */
    public final TableField<LabReporteBiopsiaVwRecord, Integer> PROCEDIMIENTO = createField(DSL.name("procedimiento"), SQLDataType.INTEGER, this, "");
    ...
    /**
     * The column <code>public.lab_reporte_biopsia_vw.tipo_cirugia</code>.
     */
    public final TableField<LabReporteBiopsiaVwRecord, Integer> TIPO_CIRUGIA = createField(DSL.name("tipo_cirugia"), SQLDataType.INTEGER, this, "");
    ...
    /**
     * The column <code>public.lab_reporte_biopsia_vw.instrumento</code>.
     */
    public final TableField<LabReporteBiopsiaVwRecord, Integer> INSTRUMENTO = createField(DSL.name("instrumento"), SQLDataType.INTEGER, this, "");
    ...
    /**
     * The column <code>public.lab_reporte_biopsia_vw.usuario_biopsia</code>.
     */
    public final TableField<LabReporteBiopsiaVwRecord, Integer> USUARIO_BIOPSIA = createField(DSL.name("usuario_biopsia"), SQLDataType.INTEGER, this, "");
