    ...
    <fieldset id="biopsia-recibo">
        <table>
            <tr>
                ...
                <td><input id="numeroBiopsia" class="form-control" readonly value=""></td>
                <td><label for="fechaBiopsia">Fecha Biopsia:</label></td>
                <td><input id="fechaBiopsia" class="form-control" readonly value=""></td>
                <td><label for="estadoBiopsia">Estado:</label></td>
                <td><input id="estadoBiopsia" class="form-control" readonly value=""></td>
            </tr>
            <tr>
                <td><label class="table-form-label" for="numReciboBiopsia">Numero Recibo:</label></td>
                <td><input type="text" id="numReciboBiopsia" class="form-control"></td>

                <td><label class="table-form-label" for="serieReciboBiopsia">Serie Recibo:</label></td>
                <td><input type="text" id="serieReciboBiopsia" class="form-control"></td>

                <td><label class="table-form-label" for="montoReciboBiopsia">Monto Recibo:</label></td>
                <td><input type="text" id="montoReciboBiopsia" class="form-control"></td>
                <td>
    ...
    <fieldset id="biopsia-datos" disabled="disabled">
        ...
        <table>
            ...
            <tr>
                ...
                <td><textArea id="observacionesBiopsia" class="form-control" cols="56" rows="5"></textArea></td>
                <td colspan="2">
