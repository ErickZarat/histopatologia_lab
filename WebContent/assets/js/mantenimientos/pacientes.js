                ...
                if(response.success) {
                    response.data.forEach(function (element) {
                        ...
                        //    + '<button type="button" class="btn btn-light" data-baja-paciente="true" ' + data + ' data-toggle="modal" data-target="#darBajaPacienteModal" id="darBajaPacienteModalBtn"><i class="far fa-calendar"></i></button>'
							+ '<a class="btn btn-light" data-toggle="tooltip" data-placement="right" title="Visualizar lista Consultas" href="ConsultaServlet.do?accion=LIST_CONSULTAS&codPaciente=' + element.codigoPaciente + '"><i class="fas fa-folder-open"></i></a>'
                            + '</div>'
                        ]
