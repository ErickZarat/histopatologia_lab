...
$(document).ready(function() {
                ...
                if(response.success) {
                    response.data.forEach(function (element) {
                        ...
                        var row = [
                            ...
                            '<div class="btn-group" >'
                            + '<button type="button" class="btn btn-light" data-modificar-usuario="true" ' + data + ' data-toggle="modal" data-target="#modificarUsuarioModal"><i class="fas fa-edit"></i></button>'
    ...
    function setUsuarioDataModificar(){
        $('#codigoUsuarioMod').val($(this).data('codigo-usuario'))
